...
function isPositive(i) {if (i>0){return true;}return false}
...
function isNegative(i) {if (i<0){return true;}return false}
...
function isOdd(i) {if (i % 2 !== 0){return true;}return false}
...
function isEven(i) {if (i % 2 === 0){return true;}return false}
...
function identity(input){if (input === input){return input;}}
...
function isPositiveOdd(i){if (i % 2 !== 0 && i > 0){return true;}return false;}
...
function isPositiveEven(i) {if (i % 2 === 0 && i > 0){return true;}return false;}
...
function isNegativeOdd(i) {if (i % 2 !== 0 && i < 0){return true;}return false}
...
function isNegativeEven(i) {if (i % 2 === 0 && i < 0 ){return true;}return false;}
...
function reverseSign(i) {if (i > 0){return i * -1;} else {return i * -1;}}
...
function absoluteValue(i) {return Math.abs(i);}
...
function isMultipleOfThree(i) {if (i % 3 === 0){return true;}return false;}
...
function isMultipleOfFive(i) {if (i % 5 === 0){return true;}return false;}
...
function isMultipleOfBothThreeAndFive(i){if (i % 3 === 0 && i % 5 === 0){return true;}return false;}
...
function squareRoot(i){return Math.sqrt(i);}
...
function quotient(a, b){return parseInt(a/b);}
...
function sumOfSquares(a, b){return ((a*a)+(b*b));}
...
function timesTwoPlusThree(i){return ((i*2)+3);}
...
function areaOfRectangle(a, b){return a * b;}
...
function areaOfCircle(r){return Math.PI * Math.pow(r, 2);}
...
function isVowel(char){if (char === 'a'|| char === 'e'||char === 'i'||char === 'o'||char === 'u'||char === 'A'||char === 'E'||char === 'I'||char === 'O'||char === 'U'){return true;}return false;}
...
function hasVowels(str) {var vowels = 'aeiou';var vcount = 0;for (var x = 0; x < str.length; x++) {if (vowels.toLowerCase().indexOf(str[x]) !== -1) {vcount++;}} return vcount > 0;}
...
function countVowels(str1){var vowel_list = 'aeiou';var vcount = 0;for(var x = 0; x < str1.length ; x++){if (vowel_list.indexOf(str1[x]) !== -1){vcount += 1;}}return vcount;}
